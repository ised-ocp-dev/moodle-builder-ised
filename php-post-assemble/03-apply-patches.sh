...
case "$VERSION" in   # Determine branch based on version of Moodle.
    ...
    37) # MOODLE 3.7 - Bug fixes until May 2020. Security patches until November 2020.
		...
		git cherry-pick origin/MDL-68766b-M37 # auth: Login form: 'Log in using...' should be h3, not h6. (b version includes MDL-68765)
    ;;
    38) # MOODLE 3.8 - Bug fixes until November 2020. Security patches until May 2021.
		...
		git cherry-pick origin/MDL-68766b-M38 # auth: Login form: 'Log in using...' should be h3, not h6. (b version includes MDL-68765)
    ...
    39) # MOODLE 3.9 X-LTS (master) - Bug fixes until May 2021. Security patches until May 2024. (to be confirmed when launched)
		...
		git cherry-pick origin/MDL-68766b-master # auth: Login form: 'Log in using...' should be h3, not h6. (b version includes MDL-68765)
    ;;
